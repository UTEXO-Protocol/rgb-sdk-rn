...
- (void)rlnFailTransfers:(double)nodeId
         batchTransferIdx:(NSNumber * _Nullable)batchTransferIdx
              noAssetOnly:(BOOL)noAssetOnly
                 skipSync:(BOOL)skipSync
                  resolve:(RCTPromiseResolveBlock)resolve
                   reject:(RCTPromiseRejectBlock)reject
...
- (void)rlnLnInvoice:(double)nodeId
              amtMsat:(NSNumber * _Nullable)amtMsat
...
- (void)rlnRgbInvoice:(double)nodeId
               assetId:(NSString * _Nullable)assetId
      assignmentAmount:(NSNumber * _Nullable)assignmentAmount
       durationSeconds:(NSNumber * _Nullable)durationSeconds
      minConfirmations:(double)minConfirmations
...
{
    EXEC_ASYNC({
        NSDictionary *result = [RgbSwiftHelper _rlnSendRgb:@(nodeId) donation:donation feeRate:@(feeRate) minConfirmations:@(minConfirmations) skipSync:skipSync];
        NSString *errorMessage = result[@"error"];
        if (errorMessage != nil) {
